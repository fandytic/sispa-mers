                            ...
                            <tbody>
                                ...
                                foreach($data as $d){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../ProsesA/d_riwayat.php?id_diagnosa=<?php print $d['id_diagnosa']; ?>" class="btn btn-danger btn-simple btn-xs text-white" title="Hapus Riwayat"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
