							...
							<div class="card-body">
								<form method="post" class="form-horizontal form-material" action="../ProsesA/e_gejala.php">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" value="<?php print $g->kode; ?>" placeholder="" class="form-control form-control-line" name="kode" readonly="true">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-12">Nama Gejala</label>
										<div class="col-md-12">
											<input type="text" value="<?php print $g->nama; ?>" class="form-control form-control-line" name="nama">
										</div>
									</div>
